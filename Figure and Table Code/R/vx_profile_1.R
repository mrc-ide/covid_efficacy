vx_profile_altsev <- function(vfr,
                       vaccine,
                       sample,
                       d1,
                       om_red,
  ...
  efficacy_dose1_severe <- 1 - (1-efficacy_dose1_infection)*exp(ab50_s)
  efficacy_dose1_death <- 1 - (1-efficacy_dose1_infection)*exp(ab50_d)
  

  n2=mu_ab_d2 + cum_dr_vec
 
  efficacy_dose2_infection <- 1/(1+exp(-k*(n2 -ab50)))
  efficacy_dose2_severe <- 1 - (1-efficacy_dose2_infection)*exp(ab50_s)
  efficacy_dose2_death <- 1 - (1-efficacy_dose2_infection)*exp(ab50_d)
  ...
  efficacy_dose3_severe <- 1 - (1-efficacy_dose3_infection)*exp(ab50_s)
  efficacy_dose3_death <- 1 - (1-efficacy_dose3_infection)*exp(ab50_d)
